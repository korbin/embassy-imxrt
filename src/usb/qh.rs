...
impl Qh {
    ...
    pub fn set_max_packet_len(&mut self, max_packet_len: usize) {
        ral_registers::modify_reg!(super::qh, self, CAPABILITIES, MAXIMUM_PACKET_LENGTH: max_packet_len.min(1024) as u32);
    }

    /// Returns the maximum packet length
    pub fn max_packet_len(&self) -> usize {
        ral_registers::read_reg!(super::qh, self, CAPABILITIES, MAXIMUM_PACKET_LENGTH) as usize
    }
    ...
    pub fn set_zero_length_termination(&mut self, zlt: bool) {
        ...
        ral_registers::modify_reg!(super::qh, self, CAPABILITIES, ZLT: !zlt as u32);
    }

    /// Enable (true) or disable (false) interrupt on setup
    pub fn set_interrupt_on_setup(&mut self, ios: bool) {
        ral_registers::modify_reg!(super::qh, self, CAPABILITIES, IOS: ios as u32);
    }
