...
///
/// ```
/// use embassy_imxrt::usb::EndpointMemory;
///
...
impl<const SIZE: usize> EndpointMemory<SIZE> {
    ...
    pub fn allocator(&'static self) -> Option<Allocator> {
...
unsafe impl Send for super::buffer::Allocator {}
...
impl Buffer {
    ...
    pub fn clean_invalidate_dcache(&self, len: usize) {
        super::cache::clean_invalidate_dcache_by_address(self.ptr as usize, self.len.min(len));
    }
}
