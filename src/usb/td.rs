...
impl Td {
    ...
    pub fn set_buffer(&mut self, ptr: *mut u8, size: usize) {
        ral_registers::modify_reg!(super::td, self, TOKEN, TOTAL_BYTES: size as u32);
    ...
    pub fn set_interrupt_on_complete(&mut self, ioc: bool) {
        ral_registers::modify_reg!(super::td, self, TOKEN, IOC: ioc as u32);
    }

    /// Clean and invalidate this TD from DCache
    pub fn clean_invalidate_dcache(&self) {
        super::cache::clean_invalidate_dcache_by_address(
...
mod test {
    ...
    fn status() {
        let mut td = Td::new();
        ral_registers::write_reg!(super, &mut td, TOKEN, STATUS: u32::max_value());
    ...
    fn ioc() {
        let mut td = Td::new();
        ral_registers::write_reg!(super, &mut td, TOKEN, IOC: u32::max_value());
    ...
    fn total_bytes() {
        let mut td = Td::new();
        ral_registers::write_reg!(super, &mut td, TOKEN, TOTAL_BYTES: u32::max_value());
